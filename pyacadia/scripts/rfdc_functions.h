/*
 * rfdc_functions.h
 * Declarations of functions supported by pyxrfdc
...
// #define Xil_AssertNonvoid(Expression) { if (!(Expression)) { while (1) ; } }
// #define Xil_AssertVoid(Expression) { if (!(Expression)) { while (1) ; } }
// #define Xil_AssertVoidAlways() { while (1) ; }
