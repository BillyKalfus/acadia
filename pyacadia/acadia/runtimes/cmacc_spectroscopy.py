...
class CMACCSpectroscopyRuntime(Runtime):
    ...
    def main(self, directory: str, datamanager: DataManager):
        ...
        datamanager.create_group(ArrayRecordGroup, "streams", capture_time=capture_time)
        ...
        def sequence(a: Acadia):
            ...
            # with a.sequencer().loop(1000):
            #     pass
                
            for i in range(100):
                a.sequencer().nop()

            stream_count[0] = a.stream_count(cfg)
        ...
        for i in datamanager.count(self.iterations, "Iterations"):
            for idx_frequency,frequency in enumerate(datamanager.count(self.frequencies, "Frequencies")):
                ...
                datamanager.write("streams", stream_count)
