...
class StandardFirmware(Firmware):
    ...
    def write_hedgehog_tcl(self, filename="hedgehog.tcl"):
        ...
        with open(self._hedgehog_tcl_filename, "w") as f:
            ...
            set_property(f, {"CDC_TYPE {xpm_cdc_sync_rst}] [get_bd_cells hedgehog/xpm_cdc_aresetn_PS_clk_250]\n")
            ...
            # 6 Slaves: RFDC, Clocking, BRAM controller for DMA/instructions, BRAM controller for DAC wave memory, BRAM controller for cache
            create_ip(f, name="hedgehog/config_smartconnect", vlnv="xilinx.com:ip:smartconnect:1.0")
            set_property(f, name="hedgehog/config_smartconnect", properties={"NUM_MI": 5, "NUM_SI": 2, "NUM_CLKS": 2})
            ...
            assign_bd_address(f, target_address_space="/ps/Data", addr_seg="hedgehog/rfdc/s_axi/Reg", offset=RFDC_ADDR, range="256K")
            ...
            assign_bd_address(f, target_address_space="/ps/Data", addr_seg="hedgehog/clk_wiz/s_axi_lite/Reg", offset=CLK_WIZ_ADDR, range="256K")
            ...
            assign_bd_address(f, target_address_space="/ps/Data", offset=DDR4_C0_ADDR, range="4G", addr_seg="DDR4_C0_MIG/C0_DDR4_MEMORY_MAP/C0_DDR4_ADDRESS_BLOCK")

            connect_bd_intf_net(f, f"hedgehog/DDR4_C1_S_AXI", f"hedgehog/memory_smartconnect/M05_AXI")
            assign_bd_address(f, target_address_space="/ps/Data", offset=DDR4_C1_ADDR, range="4G", addr_seg="DDR4_C1_MIG/C0_DDR4_MEMORY_MAP/C0_DDR4_ADDRESS_BLOCK")
            ...
            create_ip(f, name=f"hedgehog/axi_bram_ctrl_{mem_decoder.name}", vlnv="xilinx.com:ip:axi_bram_ctrl:4.1")
            set_property(f, name=f"hedgehog/axi_bram_ctrl_{mem_decoder.name}", properties={"DATA_WIDTH": 128, "SINGLE_PORT_BRAM": 1, "ECC_TYPE": 0, "READ_LATENCY": 3})
            ...
            set_property(f, name=f"hedgehog/axi_bram_ctrl_{mem_decoder.name}_addr_slice", properties={"DATA_WIDTH": 128, "LOG2_DATA_WIDTH_BYTES": 4, "LOG2_SLAVE_SIZE_BYTES": round(np.log2(mem_decoder_addr_range))})
            assign_bd_address(f, addr_seg=f"hedgehog/axi_bram_ctrl_{mem_decoder.name}/S_AXI/Mem0", target_address_space="/ps/Data", offset=BRAM_CTRL_MEM_DECODER_ADDR, range=mem_decoder_addr_range)
            ...
            create_ip(f, name=f"hedgehog/axi_bram_ctrl_{dac_mem_decoder.name}", vlnv="xilinx.com:ip:axi_bram_ctrl:4.1")
            set_property(f, name=f"hedgehog/axi_bram_ctrl_{dac_mem_decoder.name}", properties={"DATA_WIDTH": 128, "SINGLE_PORT_BRAM": 1, "ECC_TYPE": 0})
            ...
            set_property(f, name=f"hedgehog/axi_bram_ctrl_{dac_mem_decoder.name}_addr_slice", properties={"DATA_WIDTH": 128, "LOG2_DATA_WIDTH_BYTES": 4, "LOG2_SLAVE_SIZE_BYTES": round(np.log2(dac_mem_decoder_addr_range))})
            assign_bd_address(f, addr_seg=f"hedgehog/axi_bram_ctrl_{dac_mem_decoder.name}/S_AXI/Mem0", target_address_space="/ps/Data", offset=BRAM_CTRL_DAC_MEM_DECODER_ADDR, range=dac_mem_decoder_addr_range)
            ...
            set_property(f, name=f"hedgehog/axi_bram_ctrl_cache_addr_slice", properties={"DATA_WIDTH": 128, "LOG2_DATA_WIDTH_BYTES": 4, "LOG2_SLAVE_SIZE_BYTES": round(np.log2(cache_addr_range))})
            assign_bd_address(f, addr_seg="hedgehog/axi_bram_ctrl_cache/S_AXI/Mem0", target_address_space="/ps/Data", offset=BRAM_CTRL_CACHE_ADDR, range=cache_addr_range)
            ...
            assign_bd_address(f, offset=HPC0_DDR_LOW_ADDR, range="2G", target_address_space="/hedgehog/cfg_axi_dm/Data_MM2S", addr_seg="ps/SAXIGP0/HPC0_DDR_LOW")
            assign_bd_address(f, offset=HPC1_DDR_LOW_ADDR, range="2G", target_address_space="/hedgehog/cfg_axi_dm/Data_MM2S", addr_seg="ps/SAXIGP1/HPC1_DDR_LOW")
            assign_bd_address(f, offset=HP0_DDR_LOW_ADDR, range="2G", target_address_space="/hedgehog/cfg_axi_dm/Data_MM2S", addr_seg="ps/SAXIGP2/HP0_DDR_LOW")
            assign_bd_address(f, offset=HP1_DDR_LOW_ADDR, range="2G", target_address_space="/hedgehog/cfg_axi_dm/Data_MM2S", addr_seg="ps/SAXIGP3/HP1_DDR_LOW")

            # Assign the PS OCM into the AXI DataMover's address space
            assign_bd_address(f, offset=HPC0_LPS_OCM_ADDR, range="256K", target_address_space="/hedgehog/cfg_axi_dm/Data_MM2S", addr_seg="ps/SAXIGP0/HPC0_LPS_OCM")
            assign_bd_address(f, offset=HPC1_LPS_OCM_ADDR, range="256K", target_address_space="/hedgehog/cfg_axi_dm/Data_MM2S", addr_seg="ps/SAXIGP1/HPC1_LPS_OCM")
            assign_bd_address(f, offset=HP0_LPS_OCM_ADDR, range="256K", target_address_space="/hedgehog/cfg_axi_dm/Data_MM2S", addr_seg="ps/SAXIGP2/HP0_LPS_OCM")
            assign_bd_address(f, offset=HP1_LPS_OCM_ADDR, range="256K", target_address_space="/hedgehog/cfg_axi_dm/Data_MM2S", addr_seg="ps/SAXIGP3/HP1_LPS_OCM")

            # Assign the PL DDR into the AXI DataMover's address space
            assign_bd_address(f, offset=DDR4_C0_ADDR, range="4G", target_address_space="/hedgehog/cfg_axi_dm/Data_MM2S", addr_seg="DDR4_C0_MIG/C0_DDR4_MEMORY_MAP/C0_DDR4_ADDRESS_BLOCK")
            assign_bd_address(f, offset=DDR4_C1_ADDR, range="4G", target_address_space="/hedgehog/cfg_axi_dm/Data_MM2S", addr_seg="DDR4_C1_MIG/C0_DDR4_MEMORY_MAP/C0_DDR4_ADDRESS_BLOCK")
            ...
            assign_bd_address(f, target_address_space="hedgehog/cfg_axi_dm/Data_S2MM", offset=BRAM_CTRL_MEM_DECODER_ADDR, range=mem_decoder_addr_range, addr_seg=f"hedgehog/axi_bram_ctrl_{mem_decoder.name}/S_AXI/Mem0")
            assign_bd_address(f, target_address_space="hedgehog/cfg_axi_dm/Data_S2MM", offset=BRAM_CTRL_DAC_MEM_DECODER_ADDR, range=dac_mem_decoder_addr_range, addr_seg=f"hedgehog/axi_bram_ctrl_{dac_mem_decoder.name}/S_AXI/Mem0")
            assign_bd_address(f, target_address_space="hedgehog/cfg_axi_dm/Data_S2MM", offset=RFDC_ADDR, range="256K", addr_seg=f"hedgehog/rfdc/s_axi/Reg")
            assign_bd_address(f, target_address_space="hedgehog/cfg_axi_dm/Data_S2MM", offset=CLK_WIZ_ADDR, range="256K", addr_seg=f"hedgehog/clk_wiz/s_axi_lite/Reg")
            assign_bd_address(f, target_address_space="hedgehog/cfg_axi_dm/Data_S2MM", offset=BRAM_CTRL_CACHE_ADDR, range=cache_addr_range, addr_seg=f"hedgehog/axi_bram_ctrl_cache/S_AXI/Mem0")
            ...
            for d in range(4):
                ...
                set_property(f, name=f"hedgehog/axis_data_fifo_adc_dm{d}", properties={"TDATA_NUM_BYTES": 16, "FIFO_DEPTH": ADC_AXIS_FIFO_DEPTH, "HAS_TLAST": 1, "HAS_AFULL": 1})
                ...
                assign_bd_address(f, offset=HPC0_DDR_LOW_ADDR, range="2G", target_address_space=f"/hedgehog/adc_dm{d}/Data_S2MM", addr_seg="ps/SAXIGP0/HPC0_DDR_LOW")
                assign_bd_address(f, offset=HPC1_DDR_LOW_ADDR, range="2G", target_address_space=f"/hedgehog/adc_dm{d}/Data_S2MM", addr_seg="ps/SAXIGP1/HPC1_DDR_LOW")
                assign_bd_address(f, offset=HP0_DDR_LOW_ADDR, range="2G", target_address_space=f"/hedgehog/adc_dm{d}/Data_S2MM", addr_seg="ps/SAXIGP2/HP0_DDR_LOW")
                assign_bd_address(f, offset=HP1_DDR_LOW_ADDR, range="2G", target_address_space=f"/hedgehog/adc_dm{d}/Data_S2MM", addr_seg="ps/SAXIGP3/HP1_DDR_LOW")

                # Assign the PS OCM into the AXI DataMover's address space
                assign_bd_address(f, offset=HPC0_LPS_OCM_ADDR, range="256K", target_address_space=f"/hedgehog/adc_dm{d}/Data_S2MM", addr_seg="ps/SAXIGP0/HPC0_LPS_OCM")
                assign_bd_address(f, offset=HPC1_LPS_OCM_ADDR, range="256K", target_address_space=f"/hedgehog/adc_dm{d}/Data_S2MM", addr_seg="ps/SAXIGP1/HPC1_LPS_OCM")
                assign_bd_address(f, offset=HP0_LPS_OCM_ADDR, range="256K", target_address_space=f"/hedgehog/adc_dm{d}/Data_S2MM", addr_seg="ps/SAXIGP2/HP0_LPS_OCM")
                assign_bd_address(f, offset=HP1_LPS_OCM_ADDR, range="256K", target_address_space=f"/hedgehog/adc_dm{d}/Data_S2MM", addr_seg="ps/SAXIGP3/HP1_LPS_OCM")

                # Assign the PL DDR into the AXI DMA's S2MM address space
                assign_bd_address(f, offset=DDR4_C0_ADDR, range="4G", target_address_space=f"/hedgehog/adc_dm{d}/Data_S2MM", addr_seg="DDR4_C0_MIG/C0_DDR4_MEMORY_MAP/C0_DDR4_ADDRESS_BLOCK")
                assign_bd_address(f, offset=DDR4_C1_ADDR, range="4G", target_address_space=f"/hedgehog/adc_dm{d}/Data_S2MM", addr_seg="DDR4_C1_MIG/C0_DDR4_MEMORY_MAP/C0_DDR4_ADDRESS_BLOCK")
            ...
            for d in range(4):
                ...
                set_property(f, name=f"hedgehog/axis_data_fifo_cmacc_dm{d}", properties={"TDATA_NUM_BYTES": 4, "FIFO_DEPTH": CMACC_AXIS_FIFO_DEPTH, "HAS_TLAST": 1, "HAS_AFULL": 1})
                ...
                # Assign the PS DDR into the AXI DataMover's S2MM address space
                assign_bd_address(f, offset=HPC0_DDR_LOW_ADDR, range="2G", target_address_space=f"/hedgehog/cmacc_dm{d}/Data_S2MM", addr_seg="ps/SAXIGP0/HPC0_DDR_LOW")
                assign_bd_address(f, offset=HPC1_DDR_LOW_ADDR, range="2G", target_address_space=f"/hedgehog/cmacc_dm{d}/Data_S2MM", addr_seg="ps/SAXIGP1/HPC1_DDR_LOW")
                assign_bd_address(f, offset=HP0_DDR_LOW_ADDR, range="2G", target_address_space=f"/hedgehog/cmacc_dm{d}/Data_S2MM", addr_seg="ps/SAXIGP2/HP0_DDR_LOW")
                assign_bd_address(f, offset=HP1_DDR_LOW_ADDR, range="2G", target_address_space=f"/hedgehog/cmacc_dm{d}/Data_S2MM", addr_seg="ps/SAXIGP3/HP1_DDR_LOW")

                # Assign the PS OCM into the AXI DataMover's address space
                assign_bd_address(f, offset=HPC0_LPS_OCM_ADDR, range="256K", target_address_space=f"/hedgehog/cmacc_dm{d}/Data_S2MM", addr_seg="ps/SAXIGP0/HPC0_LPS_OCM")
                assign_bd_address(f, offset=HPC1_LPS_OCM_ADDR, range="256K", target_address_space=f"/hedgehog/cmacc_dm{d}/Data_S2MM", addr_seg="ps/SAXIGP1/HPC1_LPS_OCM")
                assign_bd_address(f, offset=HP0_LPS_OCM_ADDR, range="256K", target_address_space=f"/hedgehog/cmacc_dm{d}/Data_S2MM", addr_seg="ps/SAXIGP2/HP0_LPS_OCM")
                assign_bd_address(f, offset=HP1_LPS_OCM_ADDR, range="256K", target_address_space=f"/hedgehog/cmacc_dm{d}/Data_S2MM", addr_seg="ps/SAXIGP3/HP1_LPS_OCM")

                # Assign the PL DDR into the AXI DMA's S2MM address space
                assign_bd_address(f, offset=DDR4_C0_ADDR, range="4G", target_address_space=f"/hedgehog/cmacc_dm{d}/Data_S2MM", addr_seg="DDR4_C0_MIG/C0_DDR4_MEMORY_MAP/C0_DDR4_ADDRESS_BLOCK")
                assign_bd_address(f, offset=DDR4_C1_ADDR, range="4G", target_address_space=f"/hedgehog/cmacc_dm{d}/Data_S2MM", addr_seg="DDR4_C1_MIG/C0_DDR4_MEMORY_MAP/C0_DDR4_ADDRESS_BLOCK")
