...
proc print_help {} {
  variable script_file
  puts "\nDescription:"
  puts "Recreate a Vivado project for acadia."
  puts "Syntax:"
  puts "$script_file"
...
set files [list \
 [file normalize "${origin_dir}/acadia_axi_lite_regs.vhd" ]\
 [file normalize "${origin_dir}/acadia_axis_pipeline.vhd" ]\
 [file normalize "${origin_dir}/acadia_backpressure_fifo.vhd" ]\
 [file normalize "${origin_dir}/acadia_bus_gpio.vhd" ]\
 [file normalize "${origin_dir}/acadia_clocking.vhd" ]\
 ...
 [file normalize "${origin_dir}/acadia_pinmux.vhd" ]\
...
set file "acadia_axi_lite_regs.vhd"
...
set file "[file normalize "$proj_dir/main.xdc"]"
set file_imported [import_files -fileset constrs_1 [list $file]]
set file "main.xdc"
set file_obj [get_files -of_objects [get_filesets constrs_1] [list "*$file"]]
set_property -name "file_type" -value "XDC" -objects $file_obj
...
# Proc to create acadia_bd
proc create_acadia_bd { parentCell mainTclDir } {
  ...
  set list_check_ips "\ 
    ...
    xilinx.com:ip:gtwizard_ultrascale:1.7\
  ...
  # Hierarchical cell: main
  proc create_hier_cell_main { parentCell nameHier } {

    variable script_folder

    if { $parentCell eq "" || $nameHier eq "" } {
      catch {common::send_gid_msg -ssname BD::TCL -id 2092 -severity "ERROR" "create_hier_cell_main() - Empty argument(s)!"}
      return
    }
    ...
    create_bd_intf_pin -mode Master -vlnv xilinx.com:interface:bram_rtl:1.0 gty_controller

    create_bd_intf_pin -mode Master -vlnv xilinx.com:interface:gpio_rtl:1.0 sequencer_gpio
    ...
    create_bd_intf_pin -mode Slave -vlnv xilinx.com:display_usp_rf_data_converter:diff_pins_rtl:1.0 rfdc_sysref
    ...
    create_bd_pin -dir I sequencer_nrst
    create_bd_pin -dir O sequencer_done
    create_bd_pin -dir I PS_AXI_clk
    create_bd_pin -dir I PS_async_resetn
    create_bd_pin -dir I PS_AXI_clk_interconnect_aresetn
    create_bd_pin -dir I PS_AXI_clk_peripheral_aresetn
    create_bd_pin -dir O -from 7 -to 0 ps_gdma_clk
    create_bd_pin -dir I -from 7 -to 0 ps_gdma_cack
    create_bd_pin -dir O -from 7 -to 0 ps_gdma_cvld
    ...
    create_bd_pin -dir O -from 31 -to 0 dma_flags

    create_bd_pin -dir I seq_clk
    create_bd_pin -dir I seq_sysref
  ...
  # Hierarchical cell: PLDDR
  proc create_hier_cell_plddr { parentCell nameHier } {
    ...
    # Create interface pins
    create_bd_intf_pin -mode Master -vlnv xilinx.com:interface:ddr4_rtl:1.0 C0
    create_bd_intf_pin -mode Master -vlnv xilinx.com:interface:ddr4_rtl:1.0 C1
    ...
    create_bd_intf_pin -mode Slave -vlnv xilinx.com:interface:aximm_rtl:1.0 C0_S_AXI
    create_bd_intf_pin -mode Slave -vlnv xilinx.com:interface:aximm_rtl:1.0 C1_S_AXI

    # Create pins
    create_bd_pin -dir O C0_ui_clk
    create_bd_pin -dir O C1_ui_clk
    create_bd_pin -dir O C0_cal_complete
    create_bd_pin -dir O C1_cal_complete
    create_bd_pin -dir I C0_sys_rst
    create_bd_pin -dir I C1_sys_rst
    ...
    set xpm_cdc_DDR4_C0_sys_rst [ create_bd_cell -type ip -vlnv xilinx.com:ip:xpm_cdc_gen:1.0 xpm_cdc_DDR4_C0_sys_rst ]
      set_property -dict [ list \
      CONFIG.CDC_TYPE {xpm_cdc_sync_rst} \
    ] $xpm_cdc_DDR4_C0_sys_rst

    set xpm_cdc_DDR4_C1_sys_rst [ create_bd_cell -type ip -vlnv xilinx.com:ip:xpm_cdc_gen:1.0 xpm_cdc_DDR4_C1_sys_rst ]
      set_property -dict [ list \
      CONFIG.CDC_TYPE {xpm_cdc_sync_rst} \
    ] $xpm_cdc_DDR4_C1_sys_rst

    set xpm_cdc_DDR4_C0_aresetn [ create_bd_cell -type ip -vlnv xilinx.com:ip:xpm_cdc_gen:1.0 xpm_cdc_DDR4_C0_aresetn ]
      set_property -dict [ list \
      CONFIG.CDC_TYPE {xpm_cdc_sync_rst} \
    ] $xpm_cdc_DDR4_C0_aresetn

    set xpm_cdc_DDR4_C1_aresetn [ create_bd_cell -type ip -vlnv xilinx.com:ip:xpm_cdc_gen:1.0 xpm_cdc_DDR4_C1_aresetn ]
      set_property -dict [ list \
      CONFIG.CDC_TYPE {xpm_cdc_sync_rst} \
    ] $xpm_cdc_DDR4_C1_aresetn

    connect_bd_intf_net [get_bd_intf_pins C0] [get_bd_intf_pins DDR4_C0_MIG/C0_DDR4]
    connect_bd_intf_net [get_bd_intf_pins C0_SYS_CLK] [get_bd_intf_pins DDR4_C0_MIG/C0_SYS_CLK]
    connect_bd_intf_net [get_bd_intf_pins C1] [get_bd_intf_pins DDR4_C1_MIG/C0_DDR4]
    connect_bd_intf_net [get_bd_intf_pins C1_SYS_CLK] [get_bd_intf_pins DDR4_C1_MIG/C0_SYS_CLK]
    connect_bd_intf_net [get_bd_intf_pins C0_S_AXI] [get_bd_intf_pins DDR4_C0_MIG/C0_DDR4_S_AXI] 
    connect_bd_intf_net [get_bd_intf_pins C1_S_AXI] [get_bd_intf_pins DDR4_C1_MIG/C0_DDR4_S_AXI] 

    connect_bd_net [get_bd_pins aresetn] [get_bd_pins xpm_cdc_DDR4_C0_aresetn/src_rst] [get_bd_pins xpm_cdc_DDR4_C1_aresetn/src_rst]

    connect_bd_net [get_bd_pins DDR4_C0_MIG/c0_ddr4_ui_clk] [get_bd_pins C0_ui_clk] [get_bd_pins xpm_cdc_DDR4_C0_aresetn/dest_clk] [get_bd_pins xpm_cdc_DDR4_C0_sys_rst/dest_clk]
    connect_bd_net [get_bd_pins DDR4_C0_MIG/c0_ddr4_aresetn] [get_bd_pins xpm_cdc_DDR4_C0_aresetn/dest_rst_out]
    connect_bd_net [get_bd_pins DDR4_C0_MIG/c0_init_calib_complete] [get_bd_pins C0_cal_complete]
    connect_bd_net [get_bd_pins C0_sys_rst] [get_bd_pins xpm_cdc_DDR4_C0_sys_rst/src_rst]
    connect_bd_net [get_bd_pins xpm_cdc_DDR4_C0_sys_rst/dest_rst_out] [get_bd_pins DDR4_C0_MIG/sys_rst]

    connect_bd_net [get_bd_pins DDR4_C1_MIG/c0_ddr4_ui_clk] [get_bd_pins C1_ui_clk] [get_bd_pins xpm_cdc_DDR4_C1_aresetn/dest_clk] [get_bd_pins xpm_cdc_DDR4_C1_sys_rst/dest_clk]
    connect_bd_net [get_bd_pins DDR4_C1_MIG/c0_ddr4_aresetn] [get_bd_pins xpm_cdc_DDR4_C1_aresetn/dest_rst_out]
    connect_bd_net [get_bd_pins DDR4_C1_MIG/c0_init_calib_complete] [get_bd_pins C1_cal_complete]
    connect_bd_net [get_bd_pins C1_sys_rst] [get_bd_pins xpm_cdc_DDR4_C1_sys_rst/src_rst]
  ...
  proc create_hier_cell_gty { parentCell nameHier } {
    ...
    set_property -dict [ list \
      ...
      CONFIG.RX_COMMA_M_VAL {0110000011} \
      CONFIG.RX_COMMA_PRESET {K28.1} \
      CONFIG.RX_COMMA_P_ENABLE {true} \
      CONFIG.RX_COMMA_P_VAL {1001111100} \
  ...
  # Create interface ports for physical top-level connections
  create_bd_intf_port -mode Slave -vlnv xilinx.com:interface:diff_clock_rtl:1.0 CLK104_PL_CLK
  create_bd_intf_port -mode Slave -vlnv xilinx.com:interface:diff_clock_rtl:1.0 CLK104_PL_SYSREF
  create_bd_intf_port -mode Master -vlnv xilinx.com:interface:diff_clock_rtl:1.0 CLK104_SFP_REC_CLK
  # create_bd_intf_port -mode Master -vlnv xilinx.com:interface:diff_clock_rtl:1.0 IDT_8A34001_CLK1
  create_bd_intf_port -mode Master -vlnv xilinx.com:interface:diff_clock_rtl:1.0 IDT_8A34001_CLK5
  create_bd_intf_port -mode Master -vlnv xilinx.com:interface:diff_clock_rtl:1.0 IDT_8A34001_CLK6
  create_bd_intf_port -mode Slave -vlnv xilinx.com:interface:diff_clock_rtl:1.0 IDT_8A34001_Q11
  create_bd_intf_port -mode Slave -vlnv xilinx.com:interface:diff_clock_rtl:1.0 IDT_8A34001_Q1
  create_bd_intf_port -mode Slave -vlnv xilinx.com:interface:diff_clock_rtl:1.0 IDT_8A34001_Q2
  create_bd_intf_port -mode Slave -vlnv xilinx.com:interface:diff_clock_rtl:1.0 IDT_8A34001_Q3
  create_bd_intf_port -mode Slave -vlnv xilinx.com:interface:diff_clock_rtl:1.0 IDT_8A34001_Q7
  create_bd_intf_port -mode Slave -vlnv xilinx.com:interface:diff_clock_rtl:1.0 IDT_8A34001_Q8
  create_bd_intf_port -mode Master -vlnv xilinx.com:interface:ddr4_rtl:1.0 DDR4_C0
  create_bd_intf_port -mode Master -vlnv xilinx.com:interface:ddr4_rtl:1.0 DDR4_C1
  create_bd_intf_port -mode Slave -vlnv xilinx.com:interface:diff_clock_rtl:1.0 FMCP_CLK1_M2C
  ...
  create_bd_intf_port -mode Master -vlnv xilinx.com:interface:gt_rtl:1.0 MGT128_C0
  create_bd_intf_port -mode Master -vlnv xilinx.com:interface:gt_rtl:1.0 MGT128_C1
  create_bd_intf_port -mode Master -vlnv xilinx.com:interface:gt_rtl:1.0 MGT129_C0
  create_bd_intf_port -mode Master -vlnv xilinx.com:interface:gt_rtl:1.0 MGT129_C1
  create_bd_intf_port -mode Slave -vlnv xilinx.com:interface:diff_clock_rtl:1.0 DDR4_C0_SYS_CLK
  create_bd_intf_port -mode Slave -vlnv xilinx.com:interface:diff_clock_rtl:1.0 DDR4_C1_SYS_CLK

  # Assign frequencies to the clock ports
  set_property -dict [ list CONFIG.FREQ_HZ {300000000} ] [get_bd_intf_ports DDR4_C0_SYS_CLK]
  set_property -dict [ list CONFIG.FREQ_HZ {300000000} ] [get_bd_intf_ports DDR4_C1_SYS_CLK]

  

  # Physical ports for RFDC
  create_bd_intf_port -mode Slave -vlnv xilinx.com:display_usp_rf_data_converter:diff_pins_rtl:1.0 rfdc_sysref
  ...
  # Assorted I/O ports
  create_bd_port -dir IO -from 15 -to 0 ADCIO
  create_bd_port -dir IO -from 15 -to 0 DACIO
  create_bd_port -dir IO -from 15 -to 0 IDT_8A34001_GPIO
  create_bd_port -dir O CLK104_sync
  create_bd_port -dir O -from 1 -to 0 CLK104_SPI_sel
  create_bd_port -dir IO -from 7 -to 0 PMOD0
  create_bd_port -dir IO -from 7 -to 0 PMOD1

  create_bd_cell -type module -reference acadia_pinmux acadia_pinmux_inst
  create_bd_cell -type module -reference acadia_clocking acadia_clocking_inst
  ...
  create_bd_cell -type ip -vlnv xilinx.com:ip:axi_protocol_converter:2.1 top_interconnect_protocol_converter
  set_property -dict [ list CONFIG.NUM_MI {3} ] [get_bd_cells top_interconnect]
  ...
  set_property -dict [ list \
    ...
    CONFIG.PSU__CRL_APB__SPI1_REF_CTRL__DIVISOR0 {15} \
  ...
  # Connect things from the bd ports/pins to their respective hierarchical cells or modules
  # Various clocks and resets
  connect_bd_net [get_bd_pins acadia_pinmux_inst/s_axi_aclk] [get_bd_pins ps/pl_clk0]
  connect_bd_net [get_bd_pins acadia_pinmux_inst/s_axi_aresetn] [get_bd_pins proc_sys_reset_PS_AXI_clk/peripheral_aresetn]

  connect_bd_net [get_bd_pins acadia_clocking_inst/s_axi_aclk] [get_bd_pins ps/pl_clk0]
  connect_bd_net [get_bd_pins acadia_clocking_inst/s_axi_aresetn] [get_bd_pins proc_sys_reset_PS_AXI_clk/peripheral_aresetn]

  # CLK104
  connect_bd_intf_net [get_bd_intf_ports CLK104_PL_CLK] [get_bd_intf_pins acadia_clocking_inst/CLK104_PL_CLK]
  connect_bd_net [get_bd_pins acadia_clocking_inst/seq_clk] [get_bd_pins main/seq_clk]

  connect_bd_intf_net [get_bd_intf_ports CLK104_PL_SYSREF] [get_bd_intf_pins acadia_clocking_inst/CLK104_PL_SYSREF]
  connect_bd_net [get_bd_pins acadia_clocking_inst/seq_sysref] [get_bd_pins main/seq_sysref]

  connect_bd_intf_net [get_bd_intf_ports CLK104_SFP_REC_CLK] [get_bd_intf_pins acadia_clocking_inst/CLK104_SFP_REC_CLK]

  connect_bd_net [get_bd_pins acadia_pinmux_inst/CLK104_SPI_sel] [get_bd_ports CLK104_SPI_sel] 
  connect_bd_net [get_bd_pins acadia_pinmux_inst/CLK104_sync] [get_bd_ports CLK104_sync] 

  # 8A34001
  connect_bd_intf_net [get_bd_intf_ports IDT_8A34001_Q1] [get_bd_intf_pins acadia_clocking_inst/IDT_8A34001_Q1]
  connect_bd_intf_net [get_bd_intf_ports IDT_8A34001_Q2] [get_bd_intf_pins acadia_clocking_inst/IDT_8A34001_Q2]
  connect_bd_intf_net [get_bd_intf_ports IDT_8A34001_Q3] [get_bd_intf_pins acadia_clocking_inst/IDT_8A34001_Q3]
  connect_bd_intf_net [get_bd_intf_ports IDT_8A34001_Q8] [get_bd_intf_pins acadia_clocking_inst/IDT_8A34001_Q8]
  # connect_bd_intf_net [get_bd_intf_ports IDT_8A34001_CLK1] [get_bd_intf_pins acadia_clocking_inst/IDT_8A34001_CLK1]
  connect_bd_net [get_bd_pins acadia_pinmux_inst/IDT_8A34001_GPIO] [get_bd_ports IDT_8A34001_GPIO]

  # Clock from FMC
  connect_bd_intf_net [get_bd_intf_ports FMCP_CLK1_M2C] [get_bd_intf_pins acadia_clocking_inst/FMCP_CLK1_M2C]

  # PLDDR
  connect_bd_intf_net [get_bd_intf_ports DDR4_C0] [get_bd_intf_pins PLDDR/C0]
  connect_bd_intf_net [get_bd_intf_ports DDR4_C0_SYS_CLK] [get_bd_intf_pins PLDDR/C0_SYS_CLK]
  connect_bd_intf_net [get_bd_intf_ports DDR4_C1] [get_bd_intf_pins PLDDR/C1]
  connect_bd_intf_net [get_bd_intf_ports DDR4_C1_SYS_CLK] [get_bd_intf_pins PLDDR/C1_SYS_CLK]

  connect_bd_intf_net [get_bd_intf_pins PLDDR/C0_S_AXI] [get_bd_intf_pins main/DDR4_C0_S_AXI]
  connect_bd_intf_net [get_bd_intf_pins PLDDR/C1_S_AXI] [get_bd_intf_pins main/DDR4_C1_S_AXI]

  connect_bd_net [get_bd_pins acadia_pinmux_inst/DDR4_C0_sys_rst] [get_bd_pins PLDDR/C0_sys_rst]
  connect_bd_net [get_bd_pins acadia_pinmux_inst/DDR4_C1_sys_rst] [get_bd_pins PLDDR/C1_sys_rst]
  connect_bd_net [get_bd_pins acadia_pinmux_inst/DDR4_C0_cal_complete] [get_bd_pins PLDDR/C0_cal_complete] 
  connect_bd_net [get_bd_pins acadia_pinmux_inst/DDR4_C1_cal_complete] [get_bd_pins PLDDR/C1_cal_complete]  

  connect_bd_net [get_bd_pins PLDDR/C0_ui_clk] [get_bd_pins main/DDR4_C0_ui_clk] 
  ...
  # PS AXI connections
  connect_bd_intf_net [get_bd_intf_pins ps/S_AXI_HP0_FPD] [get_bd_intf_pins main/PS_S_AXI_HP0]
  connect_bd_intf_net [get_bd_intf_pins ps/S_AXI_HP1_FPD] [get_bd_intf_pins main/PS_S_AXI_HP1]
  connect_bd_intf_net [get_bd_intf_pins ps/S_AXI_HPC0_FPD] [get_bd_intf_pins main/PS_S_AXI_HPC0]
  connect_bd_intf_net [get_bd_intf_pins ps/S_AXI_HPC1_FPD] [get_bd_intf_pins main/PS_S_AXI_HPC1]

  connect_bd_intf_net [get_bd_intf_pins ps/M_AXI_HPM0_FPD] [get_bd_intf_pins main/PS_M_AXI0] 
  connect_bd_intf_net [get_bd_intf_pins ps/M_AXI_HPM1_FPD] [get_bd_intf_pins main/PS_M_AXI1] 
  ...
  # Top interconnect protocol converter
  connect_bd_net [get_bd_pins top_interconnect_protocol_converter/aclk] [get_bd_pins ps/pl_clk0] 
  connect_bd_net [get_bd_pins top_interconnect_protocol_converter/aresetn] [get_bd_pins proc_sys_reset_PS_AXI_clk/interconnect_aresetn]
  connect_bd_intf_net [get_bd_intf_pins ps/M_AXI_HPM0_LPD] [get_bd_intf_pins top_interconnect_protocol_converter/S_AXI] 
  ...
  connect_bd_net [get_bd_pins top_interconnect/aclk] [get_bd_pins ps/pl_clk0]
  connect_bd_net [get_bd_pins top_interconnect/s00_aclk] [get_bd_pins ps/pl_clk0]
  connect_bd_net [get_bd_pins top_interconnect/m00_aclk] [get_bd_pins ps/pl_clk0]
  connect_bd_net [get_bd_pins top_interconnect/m01_aclk] [get_bd_pins ps/pl_clk0]
  connect_bd_net [get_bd_pins top_interconnect/m02_aclk] [get_bd_pins ps/pl_clk0]
  connect_bd_net [get_bd_pins top_interconnect/aresetn] [get_bd_pins proc_sys_reset_PS_AXI_clk/interconnect_aresetn]
  connect_bd_net [get_bd_pins top_interconnect/s00_aresetn] [get_bd_pins proc_sys_reset_PS_AXI_clk/interconnect_aresetn]
  connect_bd_net [get_bd_pins top_interconnect/m00_aresetn] [get_bd_pins proc_sys_reset_PS_AXI_clk/interconnect_aresetn]
  connect_bd_net [get_bd_pins top_interconnect/m01_aresetn] [get_bd_pins proc_sys_reset_PS_AXI_clk/interconnect_aresetn]
  connect_bd_net [get_bd_pins top_interconnect/m02_aresetn] [get_bd_pins proc_sys_reset_PS_AXI_clk/interconnect_aresetn]

  # RFDC
  connect_bd_intf_net [get_bd_intf_ports rfdc_sysref] [get_bd_intf_pins main/rfdc_sysref]

  connect_bd_intf_net [get_bd_intf_ports vout00] [get_bd_intf_pins main/vout00]
  connect_bd_intf_net [get_bd_intf_ports vout01] [get_bd_intf_pins main/vout01]
  connect_bd_intf_net [get_bd_intf_ports vout02] [get_bd_intf_pins main/vout02]
  connect_bd_intf_net [get_bd_intf_ports vout03] [get_bd_intf_pins main/vout03]
  connect_bd_intf_net [get_bd_intf_ports vout10] [get_bd_intf_pins main/vout10]
  connect_bd_intf_net [get_bd_intf_ports vout11] [get_bd_intf_pins main/vout11]
  connect_bd_intf_net [get_bd_intf_ports vout12] [get_bd_intf_pins main/vout12]
  connect_bd_intf_net [get_bd_intf_ports vout13] [get_bd_intf_pins main/vout13]
  connect_bd_intf_net [get_bd_intf_ports vout20] [get_bd_intf_pins main/vout20]
  connect_bd_intf_net [get_bd_intf_ports vout21] [get_bd_intf_pins main/vout21]
  connect_bd_intf_net [get_bd_intf_ports vout22] [get_bd_intf_pins main/vout22]
  connect_bd_intf_net [get_bd_intf_ports vout23] [get_bd_intf_pins main/vout23]
  connect_bd_intf_net [get_bd_intf_ports vout30] [get_bd_intf_pins main/vout30]
  connect_bd_intf_net [get_bd_intf_ports vout31] [get_bd_intf_pins main/vout31]
  connect_bd_intf_net [get_bd_intf_ports vout32] [get_bd_intf_pins main/vout32]
  connect_bd_intf_net [get_bd_intf_ports vout33] [get_bd_intf_pins main/vout33]
  connect_bd_intf_net [get_bd_intf_ports vin00] [get_bd_intf_pins main/vin00]
  connect_bd_intf_net [get_bd_intf_ports vin01] [get_bd_intf_pins main/vin01]
  connect_bd_intf_net [get_bd_intf_ports vin02] [get_bd_intf_pins main/vin02]
  connect_bd_intf_net [get_bd_intf_ports vin03] [get_bd_intf_pins main/vin03]
  connect_bd_intf_net [get_bd_intf_ports vin10] [get_bd_intf_pins main/vin10]
  connect_bd_intf_net [get_bd_intf_ports vin11] [get_bd_intf_pins main/vin11]
  connect_bd_intf_net [get_bd_intf_ports vin12] [get_bd_intf_pins main/vin12]
  connect_bd_intf_net [get_bd_intf_ports vin13] [get_bd_intf_pins main/vin13]
  connect_bd_intf_net [get_bd_intf_ports vin20] [get_bd_intf_pins main/vin20]
  connect_bd_intf_net [get_bd_intf_ports vin21] [get_bd_intf_pins main/vin21]
  connect_bd_intf_net [get_bd_intf_ports vin22] [get_bd_intf_pins main/vin22]
  connect_bd_intf_net [get_bd_intf_ports vin23] [get_bd_intf_pins main/vin23]
  connect_bd_intf_net [get_bd_intf_ports vin30] [get_bd_intf_pins main/vin30]
  connect_bd_intf_net [get_bd_intf_ports vin31] [get_bd_intf_pins main/vin31]
  connect_bd_intf_net [get_bd_intf_ports vin32] [get_bd_intf_pins main/vin32]
  connect_bd_intf_net [get_bd_intf_ports vin33] [get_bd_intf_pins main/vin33]

  # Pinmux masters
  connect_bd_intf_net [get_bd_intf_pins acadia_pinmux_inst/ps_gpio] [get_bd_intf_pins ps/GPIO_0]
  connect_bd_intf_net [get_bd_intf_pins acadia_pinmux_inst/ps_spi0] [get_bd_intf_pins ps/SPI_0]
  connect_bd_intf_net [get_bd_intf_pins acadia_pinmux_inst/ps_spi1] [get_bd_intf_pins ps/SPI_1]
  connect_bd_net [get_bd_pins acadia_pinmux_inst/dma_flags] [get_bd_pins main/dma_flags]

  # Other pinmux slaves
  connect_bd_net [get_bd_pins acadia_pinmux_inst/ADCIO] [get_bd_ports ADCIO] 
  connect_bd_net [get_bd_pins acadia_pinmux_inst/DACIO] [get_bd_ports DACIO] 
  connect_bd_net [get_bd_pins acadia_pinmux_inst/PMOD0] [get_bd_ports PMOD0] 
  connect_bd_net [get_bd_pins acadia_pinmux_inst/PMOD1] [get_bd_ports PMOD1] 
  
  connect_bd_net [get_bd_pins acadia_pinmux_inst/sequencer_nrst] [get_bd_pins main/sequencer_nrst] 
  connect_bd_net [get_bd_pins acadia_pinmux_inst/sequencer_done] [get_bd_pins main/sequencer_done] 
  connect_bd_intf_net [get_bd_intf_pins acadia_pinmux_inst/sequencer_gpio] [get_bd_intf_pins main/sequencer_gpio]
  
  connect_bd_net [get_bd_pins acadia_pinmux_inst/ps_irq0] [get_bd_pins ps/pl_ps_irq0]  
  connect_bd_net [get_bd_pins acadia_pinmux_inst/ps_irq1]  [get_bd_pins ps/pl_ps_irq1] 

  # PS GDMA
  connect_bd_net -net main_ps_gdma_cvld [get_bd_pins main/ps_gdma_cvld] [get_bd_pins ps/perif_gdma_cvld]
  connect_bd_net -net main_ps_gdma_tack [get_bd_pins main/ps_gdma_tack] [get_bd_pins ps/perif_gdma_tack]
  connect_bd_net -net ps_gdma_cack_1 [get_bd_pins main/ps_gdma_cack] [get_bd_pins ps/gdma_perif_cack]
  connect_bd_net -net ps_gdma_irq_1 [get_bd_pins main/ps_gdma_irq] [get_bd_pins ps/ps_pl_irq_gdma_chan]
  connect_bd_net -net ps_gdma_tvld_1 [get_bd_pins main/ps_gdma_tvld] [get_bd_pins ps/gdma_perif_tvld]
  connect_bd_net [get_bd_pins main/ps_gdma_clk] [get_bd_pins ps/perif_gdma_clk]

  # PS clock, resets, and reset controller
  connect_bd_net [get_bd_pins ps/pl_clk0] [get_bd_pins main/PS_AXI_clk] [get_bd_pins proc_sys_reset_PS_AXI_clk/slowest_sync_clk]
  connect_bd_net [get_bd_pins ps/pl_resetn0] [get_bd_pins main/PS_async_resetn] [get_bd_pins PLDDR/aresetn] [get_bd_pins proc_sys_reset_PS_AXI_clk/ext_reset_in]
  connect_bd_net [get_bd_pins main/PS_AXI_clk_interconnect_aresetn] [get_bd_pins proc_sys_reset_PS_AXI_clk/interconnect_aresetn]
  connect_bd_net [get_bd_pins main/PS_AXI_clk_peripheral_aresetn] [get_bd_pins proc_sys_reset_PS_AXI_clk/peripheral_aresetn]
